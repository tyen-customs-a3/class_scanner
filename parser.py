    ...
    def parse_class_definitions(self, content: str) -> Dict[str, Any]:
        ...
        while i < len(lines):
            ...
            if line.startswith('class '):
                ...
                # Handle parent class - use empty string for no parent
                parent = ''  # Default to empty string instead of None
                if len(parts) > 1:
                ...
                # Create class data
                class_data = {
                    'parent': parent,  # Will always be string now
                    'properties': {}
                }
                
                # Handle section changes and class storage
